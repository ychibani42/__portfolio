  ...
  return (
    ...
    >
      ...
      >
        <Link
          href="#contact"
          className="group bg-gray-900 text-white px-8 py-3 flex items-center gap-2 rounded-full outline-none  hover:bg-gray-950 active:scale-105 transition"
          onClick={() => {
        ...
        <a
          ...
          href="https://github.com/ychibani42"
          target="_blank"
        >
          <FaGithubSquare />
        </a>
